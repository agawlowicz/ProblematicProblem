...
namespace ProblematicProblem
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //BoolValues boolVal = new BoolValues();
            while(cont)
            {
                ...
                {
                    cont = false;
                    Environment.Exit(0); // if the else statement hits, we exit program
                }



                //bool cont = boolVal.GetBoolValue(Console.ReadLine());
                ...
                //int userAge = int.Parse(Console.ReadLine()); //set up with do while loop instead
                bool ageIsTrue;
                int userAge;
                do
                {
                    Console.Write("What is your age? ");
                    ageIsTrue = int.TryParse(Console.ReadLine(), out userAge);
                } while (!ageIsTrue);
                ...
                while (cont)
                {
                    ...
                    Console.WriteLine();
                    cont = (Console.ReadLine().ToLower() == "redo") ? true : false; //Console.ReadLine with ternary
                }
            }
        }
    }
